...
import LanguageInputSearchPart from "../../components/languageInputSearchPart/languageInputSearchPart";
...
function Search() {
    ...
    const searchPageState = state && state.tweetBackState;
    console.log(searchPageState , "searchPageState");

    const checkRetWeet = useCheckboxYesEdit(searchPageState ?searchPageState.is_retweet: "");
    // console.log(searchPageState.is_retweet);
    const checkReply = useCheckboxYesEdit(searchPageState?searchPageState.is_reply: "");
    const checkQuote = useCheckboxYesEdit(searchPageState?searchPageState.is_quote: "");
    const checkVerified = useCheckboxYesEdit(searchPageState?searchPageState.is_verified: "");
    const checkMentions = useCheckboxYesEdit(searchPageState?searchPageState.has_mentions: "");
    const checkProfile = useCheckboxYesEdit(searchPageState?searchPageState.has_profile_geo: "");
    const checkLinks = useCheckboxYesEdit(searchPageState?searchPageState.has_links: "");
    const checkHashtags = useCheckboxYesEdit(searchPageState?searchPageState.has_hashtags: "");
    const checkMedia = useCheckboxYesEdit(searchPageState?searchPageState.has_media: "");
    const checkImages = useCheckboxYesEdit(searchPageState?searchPageState.has_images: "");
    const checkVideo = useCheckboxYesEdit(searchPageState?searchPageState.has_video: "");

    const [startDate, setStartDate] = useState("");
    const [endDate, setEndDate] = useState("");

    const [values, setValues] = useState({
        twitter_query: searchPageState? searchPageState.twitter_query: "",
        context_id:  searchPageState? searchPageState.context_id:"",
        exact_phrase: searchPageState? searchPageState.exact_phrase:'',
        hashtag: searchPageState? searchPageState.hashtag:'',
        contains: searchPageState? searchPageState.contains:'',
        max_results: searchPageState? searchPageState.max_results: 10,
        profile_country: searchPageState? searchPageState.profile_country: '',
        language: searchPageState? searchPageState.language:'',
        // start_date: '',
        // end_date:''
    });
    ...
    const handleSubmit = (e) => {
        ...
        console.log(data);
        const checkedValue = {...searchPageState}
                ...
                <div className="searchWhole">
                    <div className={"searchOne"}>
                        ...
                        <div className="searchInputDiv">
                            <label className="labelSearch" htmlFor="twitterQuery">Twitter Query *
                                <input
                                    className={`inputSearch ${!values.twitter_query && twitterQueryError ? "errorClass" : ""}`}
                                    type="text" placeholder="" id={'twitterQuery'} name="twitter_query"
                                    value={values.twitter_query} onChange={handleChange}/>
                            </label>
                        ...
                        <div className="searchInputDiv">
                            ...
                            <input className="inputSearch" type="text" placeholder="" id={'contextId'} name="context_id"
                        ...
                        <div className="searchInputDiv hidden">
                            ...
                            <input className="inputSearch" type="text" placeholder="" id={'exactPhrase'}
                                   name="exact_phrase" value={values.exact_phrase} onChange={handleChange}/>
                        </div>
                        <div className="searchInputDiv">
                            <label className="labelSearch" htmlFor="hashtag">Hashtag -#</label>
                            <input className="inputSearch" type="text" placeholder="" id={'hashtag'} name="hashtag"
                                   value={values.hashtag} onChange={handleChange}/>
                        </div>
                        <div className="searchInputDiv hidden">
                            <label className="labelSearch" htmlFor="urlContains">URL Contains</label>
                            <input className="inputSearch" type="text" placeholder="" id={'urlContains'} name="contains"
                                   value={values.contains} onChange={handleChange}/>
                        </div>
                        ...
                        <div className="searchInputSmallDiv hidden">
                            ...
                            <select className="selectInputSmall" id={'profileCountry'} name="profile_country"
                        ...
                        <LanguageInputSearchPart onhandleChange={handleChange} values={values}/>
                        <div className="selectdivs">
                            <div className="searchInputSmallDiv">
                                ...
                                <div className={"divForCalendar"}>
                                    ...
                                    <DatePicker className="inputSearchSmall" name="startDate" id={'startDate'}
                            ...
                            <div className="searchInputSmallDiv">
                                ...
                                <div className={"divForCalendar"}>
                                    ...
                                    <DatePicker className="inputSearchSmall" name="endDate" id={'endDate'}
